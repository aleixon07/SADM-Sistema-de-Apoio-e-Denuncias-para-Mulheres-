                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div id="formContainer" class="fade-in mb-5" style="display: none;">
                                    ...
                                    <form action="../../scripts/cad_categoria.php" method="POST" class="w-50">
                                        <div class="col mb-4">
                                        ...
                                        <div class="col mb-2">
                                            ...
                                            <textarea required type="text" style="height: 150px;" name="descricao" class="form-control border border-dark" placeholder="Digite o descricao"></textarea>
                                        </div>
                                ...
                                <table class="table border border-2 border-dark w-50">
                                    <thead class="table-dark">
                                        <tr>
                                            <th scope="4" class="text-light">Nome</th>
                                    ...
                                    <tbody class="table-light">
                                        ...
                                        ?>
                                                <tr>
                                                    <td scope='4' class="text-capitalize ps-3">
                                                        <?php echo $row["nome"]; ?>
                                                    </td>



                                                    <td scope="1" class='text-end pe-5'>
                                                    ...
                                                    <div class="modal-dialog ">
                                                        <div class="modal-content">
                                                            <div class="modal-header border border-dark bg-dark">
                                                                <h5 class="modal-title text-light mb-3" id="modal_adicionar">Editando Categoria</h5>
                                                            </div>
                                                            <div class="modal-body border-top border-dark  ">
                                                                <form action="../../scripts/edit_categoria.php" method="POST">
                                                                    <label for="" class="text-dark ms-2 mb-3"><strong>Nome</strong></label>
                                                                    ...
                                                                    <textarea required type="text" style="height: 150px;" name="descricao" class="form-control border border-dark" placeholder="Digite o descricao"><?php echo $row["descricao"]; ?></textarea>
    ...
    function AlertDeletAdm(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `../../scripts/delet_categoria.php?id=${id}`;
            }
        });
    }
</script>
...
?>
    <script>
        ...
        Swal.fire({
            ...
            window.location.href = "cat_denuncia.php";
...
?>
    <script>
        ...
        Swal.fire({
            title: "Atenção!",
            text: "Há uma denúncia com essa categoria, analise-a primeiro.",
            icon: "error"
